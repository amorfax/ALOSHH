...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(ALOSHH..'ooo6oo:Channel:Join')}, },}}
...
--download('https://raw.githubusercontent.com/drttp/ALOSHH/master/ALOSHH.lua','ALOSHH.lua')
